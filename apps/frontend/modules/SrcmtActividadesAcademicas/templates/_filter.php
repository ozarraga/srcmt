...
<div id="tabs">
    <ul>
        <li><a href="#tabs-1">Actividades Academicas</a></li>
    ...
    <div class="ui-widget ui-widget-content ui-corner-all">
        <form id="<?php echo $filterForm->getName() ?>" name="<?php echo $filterForm->getName() ?>" action="<?php echo url_for('SrcmtActividadesAcademicas_imprimir_lista') ?>"  target="_blank" method="POST">

...
<table id="example" class="td-brigadistas-dado td-fondo-blanco display" >
    <thead>
    ...
    <tbody  class="ui-widget ui-widget-content">
        <?php foreach ($srcmt_brigadistas_dado as $brigadista): ?>
            <tr>
                <td >
                    <?php echo link_to($brigadista->getCodigoBrigadista(), '@BrigadistasDado_show?codigo_brigadista=' . $brigadista->getCodigoBrigadista()) ?><br />
                </td>
                ...
                <td><?php echo $brigadista->getTelefonoMovil() ?></td>

...
class ImprimirActividadesAction extends sfAction {
    ...
    public function execute($request) {
        ...
        $doc_title = "Registro de Actividades del Brigadista";
        $doc_subject = "Registro de Actividades del Brigadista";
...
//        $style=$style . file_get_contents('css/srcmt.css');
	...
	<span>&nbsp;</span>';
        ...
        if ($AnchoMinimoDeColumna > $AnchoMaximoDeColumna) {
            ...
            $this->redirect('BrigadistasDado/showActividades');
        };

        // Encabezado para las paginas siguientes
        $pdf->__set('encabezado_tituloReporte', $tituloReporte . ' ' . $this->srcmt_brigadistas_dado->__toString());

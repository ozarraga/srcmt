...
class ImprimirBrigadistasAction extends sfAction
{
    ...
    public function execute($request)
    {
        ...
        $doc_keywords = "Actividades, Integración Cívico Militar, Participantes";
...
// Titulos
        ...
        $ActividadICM = $this->ActividadICM;
        ...
        $bd_in = array();
        $AICM_BD_rel = $this->ActividadICM->getSrcmtActividadIcmBrigadistaDado()->toArray();
        ...
        $mil_in = array();
        $AICM_MIL_rel = $this->ActividadICM->getSrcmtActividadIcmMiliciano()->toArray();
...
//        $style=$style . file_get_contents('css/srcmt.css');
        ...
        $html[] =
                '<h3 class="letra_azul letra_verdana " style="background-color: #F4F4F4;">&nbsp;&nbsp; Actividad de Integraci&oacute;n c&iacute;vico militar</h3>
<hr>
<h6>&nbsp;</h6>
    ...
    <tbody>
        ...
        <tr >
            <td colspan="2">
                ...
                ' . $ActividadICM->getCreatedAt() . '
            </td>
            <td colspan="2">
                <strong class="letra_azul">Actualizada el: </strong><br />
                ' . $ActividadICM->getUpdatedAt() . '
            </td>
        </tr>
    </tbody>
</table>
...
//number_format ( float $number , int $decimals = 0 , string $dec_point = '.' , string $thousands_sep = ',' )
        ...
        if ($AnchoMinimoDeColumna > $AnchoMaximoDeColumna)
        {
            ...
            $this->redirect('SrcmtActividadesIcm/showActividades');
        };

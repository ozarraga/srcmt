...
class ImprimirListaAction extends sfAction
{
    ...
    public function execute($request)
    {
        ...
        $srcmt_actividades_icm_filter = $request->getParameter($this->formFilter->getName());
        ...
        {
            $this->formFilter->bind($srcmt_actividades_icm_filter);
        }
        else
        {
        ...
        $fecha_act = $srcmt_actividades_icm_filter['fecha'];
        $createdAt = $srcmt_actividades_icm_filter['created_at'];
        $updatedAt = $srcmt_actividades_icm_filter['updated_at'];
        $fechaDesde = '';
        $fechaHasta = '';

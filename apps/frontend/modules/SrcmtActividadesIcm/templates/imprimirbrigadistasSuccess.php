...
<span id="opcion-barra" class="opcion-barra ui-corner-all ">
    <button id="" title="Redirige al registro de una nueva actividad ICM" onclick="document.location.href='<?php echo url_for('SrcmtActividadesIcm_new') ?>'">Nuevo Actividad ICM</button>
    <button id="" title="Editar la actividad ICM" onclick="document.location.href='<?php echo url_for('SrcmtActividadesIcm_edit', $ActividadICM) ?>'">Editar</button>
    <button id="" title="Muestra la lista de Actividades acad&eacute;micas" onclick="document.location.href='<?php echo url_for('SrcmtActividadesIcm') ?>'">Listar</button>
...
<div >
    <div class="data-frame">
        <div class="profile">
            <ul class="identity">                       
                <li class="even">
                    <div class="col1"><strong>Codigo Tipo Actividad</strong><?php echo $ActividadICM->getCodigoActividadIcm() ?></div>

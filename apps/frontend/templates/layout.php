							...
							<div id="contenido">
								<?php if ($sf_user->hasFlash('notice')): ?>
									<div class="ui-widget ui-state-highlight ui-corner-all">
										...
										<span class="ui-icon ui-icon-info" style="float: left; margin-right: .3em; margin-left: .2em;"></span>
										<strong>Aviso:</strong>
								...
								<?php if ($sf_user->hasFlash('error')): ?>
									<div class="ui-widget ui-state-error ui-corner-all">
										...
										<div style="padding: 5px">&nbsp;&nbsp;</div>
										<span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em; margin-left: .2em;"></span>

...
class sfGuardUserForm extends PluginsfGuardUserForm {
	...
	public function configure() {
                ...
                $this['groups_list']->setOption('renderer_class', 'sfWidgetFormSelectDoubleList');
                $this['permissions_list']->setOption('renderer_class', 'sfWidgetFormSelectDoubleList');              
...
//		);
	...
	protected function asignarMensajesValidadores() {
		...
		foreach ($this->getValidatorSchema()->getFields() as $key => $value) {
			...
			if ($value instanceof sfValidatorCSRFToken) {

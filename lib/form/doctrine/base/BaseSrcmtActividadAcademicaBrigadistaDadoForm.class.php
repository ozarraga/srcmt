...
/**
 * SrcmtActividadAcademicaBrigadistaDado form base class.
 *
 * @method SrcmtActividadAcademicaBrigadistaDado getObject() Returns the current form's model object
 *
 * @package    srcmt
 * @subpackage form
 ...
 */
abstract class BaseSrcmtActividadAcademicaBrigadistaDadoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('srcmt_actividad_academica_brigadista_dado[%s]');

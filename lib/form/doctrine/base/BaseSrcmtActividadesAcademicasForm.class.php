...
/**
 * SrcmtActividadesAcademicas form base class.
 *
 * @method SrcmtActividadesAcademicas getObject() Returns the current form's model object
 *
 * @package    srcmt
 * @subpackage form
 ...
 */
abstract class BaseSrcmtActividadesAcademicasForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'codigo_actividad_academica' => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      'codigo_actividad_academica' => new sfValidatorChoice(array('choices' => array($this->getObject()->get('codigo_actividad_academica')), 'empty_value' => $this->getObject()->get('codigo_actividad_academica'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('srcmt_actividades_academicas[%s]');
  ...
  {
    return 'SrcmtActividadesAcademicas';
  }

...
/**
 * SrcmtActividadesAcademicas filter form base class.
 *
 * @package    srcmt
 * @subpackage filter
 ...
 */
abstract class BaseSrcmtActividadesAcademicasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('srcmt_actividades_academicas_filters[%s]');
  ...
  public function addMilicianosListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('SrcmtActividadAcademicaMiliciano.codigo_miliciano', $values)
    ;
  }
  ...
  public function addBrigadistasDadoListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('SrcmtActividadAcademicaBrigadistaDado.codigo_brigadista', $values)
    ;
  }
  ...
  {
    return array(
      'codigo_actividad_academica' => 'Number',

...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\srcmt\\log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\srcmt\\cache\\frontend\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\srcmt\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('sicofipopu'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'sicofipopu',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\srcmt\\cache\\frontend\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\srcmt\\apps\\frontend/template',
)));

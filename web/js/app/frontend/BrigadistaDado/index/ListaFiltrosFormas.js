...
$(document).ready(function (){
            ...
            buttons: {
                "Aceptar": function() {
                    ...
                    oInit_Dialog.aoColumnDefs=[
                        { "bVisible": true, "aTargets": losVisibles },
                        { "bVisible": false, "aTargets": losOcultos }
                    ] ;
        ...
        $('#filtro-de-impresion').dialog({
            ...
            buttons: {
                "Crear informe PDF": function(){
                    $(this).dialog("close");
                    var formafiltro= document.getElementsByName('srcmt_brigadistas_dado_filters');
                    $(formafiltro).submit();
                },
                "Cancelar": function(){
                    $(this).dialog("close");
		...
		document.getElementById("srcmt_brigadistas_dado_filters_codigo_estado").options[0]=new Option('Seleccione un Estado','');

		$("#srcmt_brigadistas_dado_filters_codigo_estado").bind("change", this, function (event){
			var c_estado=this;
			var select_municipio = document.getElementById("srcmt_brigadistas_dado_filters_codigo_municipio");
		...
		$("#srcmt_brigadistas_dado_filters_codigo_municipio").bind("change", this, function (event){
			var c_estado=document.getElementById("srcmt_brigadistas_dado_filters_codigo_estado");
			var c_municipio = document.getElementById("srcmt_brigadistas_dado_filters_codigo_municipio");

			var select_parroquia = document.getElementById("srcmt_brigadistas_dado_filters_codigo_parroquia");
			var select_ciudad = document.getElementById("srcmt_brigadistas_dado_filters_codigo_ciudad");

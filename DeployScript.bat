...
set ARCHIVO_LOG=rsync_logfile.txt
...
set DESTINO=/home/usuario/deploy/srcmt
...
rsync %OPCIONES%  --log-file=%ARCHIVO_LOG% --exclude-from=%ROOT_DIR%/%EXCLUIR% --include-from=%ROOT_DIR%/%INCLUIR% -e=%COMANDO_SSH% %ORIGEN% %USUARIO%@%HOST%:%DESTINO%
